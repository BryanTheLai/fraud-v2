...
def test_offline_llm_stub_and_ledger(tmp_path: Path) -> None:
...
def test_llm_provider_factory_defaults_to_offline(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_novelty_ledger_ignores_malformed_lines(tmp_path: Path) -> None:
